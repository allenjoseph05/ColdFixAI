# Multiply the demo object graph up to a size worth resetting.
#
# Copied verbatim from S-0.4 rather than shared, so both spikes' datasets are
# byte-identical and their numbers are directly comparable. The duplication is
# the point: a shared script that either spike later edited would silently
